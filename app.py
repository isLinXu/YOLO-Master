    ...
    def launch(self):
        ...
        with gr.Blocks(title="YOLO-Master Studio | Agent Edition", theme=gr.themes.Base(
            ...
            with gr.Row():
                gr.Markdown(
                    "# 🚀 YOLO-Master Studio  \n"
                    "<div style='color:#4ecca3;font-size:1.1em'>"
                    "🤖 Agent-Enhanced Real-time Detection with Adaptive Intelligence</div>"
                )
                ...
                with gr.Column(scale=3):
                    with gr.Tabs():
                        ...
                        with gr.TabItem("📷 Webcam"):
                            gr.Markdown("Use your camera for real-time inference.")
                            webcam_in = gr.Image(source="webcam", streaming=True, label="Webcam", height=480)
                            # Note: Gradio 4.x streaming works differently; this is placeholder
